...
def parabolic_sar( bar , step_size = None ,  start_value = None, max_value = None  ):
      ...
      def trend_direction( trend ,high, low, sar_array, n):
        if trend == -1 :
          if  high[n] > sar_array[n-1] : return 1
          else : return -1

        elif trend == 1 :
          if low[n] < sar_array[n-1] : return -1
          else : return 1
      ...
      for n in range( period , len(sar_array) ):
          ...
          if direction == 1  :                              # Upward trend validity 
              ...
              multiplier , trend = afactor_multiplier_uptrend(n ,period,  high,  start_value , max_value, trend )
              ...
              multiplier , trend =  afactor_multiplier_downtrend(n, period,  high,  start_value , max_value, trend )
